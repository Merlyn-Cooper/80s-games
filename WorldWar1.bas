...
80  A$=CHR$(224)+CHR$(225):B$=CHR$(226)+CHR$(227):C$=CHR$(236)+CHR$(237):D$=CHR$(228)+CHR$(229)+CHR$(230)+CHR$(231):E$=CHR$(232)+CHR$(233)+CHR$(234)+CHR$(235):F$=CHR$(238)+CHR$(239):G$=CHR$(240)+CHR$(241):H$=CHR$(242)+CHR$(243)
