...
20  VDU 23, 224, 255, 8, 31, 63, 63, 30, 76, 63, 23, 225, 128, 0, 197, 254, 133, 0, 128, 0, 23, 226, 1, 0, 163, 127, 162, 0, 1, 0, 23, 227, 255, 16, 248, 252, 252, 120, 50, 252, 23, 236, 72, 1, 148, 1, 19, 134, 16, 66, 23, 237, 65, 8, 34, 144, 192, 137, 32, 130, 23, 228, 0, 1, 7, 31, 63, 127, 255, 255
30  VDU 23, 229, 63, 255, 255, 255, 255, 255, 255, 255, 23, 230, 128, 240, 252, 254, 255, 255, 255, 255, 23, 231, 0, 12, 62, 127, 255, 254, 252, 248, 23, 232, 255, 127, 63, 31, 7, 1, 0, 0, 23, 233, 255, 255, 255, 255, 255, 255, 63, 63, 23, 234, 255, 255, 255, 254, 252, 240, 128, 0
40  VDU 23, 235, 252, 254, 255, 127, 62, 12, 0, 0, 23, 238, 0, 1, 7, 15, 31, 63, 127, 127, 23, 239, 0, 128, 224, 240, 248, 252, 254, 254, 23, 240, 127, 255, 255, 255, 127, 127, 127, 63, 23, 241, 254, 255, 255, 255, 254, 254, 254, 252, 23, 242, 31, 15, 7, 1, 0, 0, 1, 1
50  VDU 23, 243, 248, 240, 224, 128, 0, 0, 128, 128, 23, 244, 0, 48, 124, 254, 255, 127, 63, 31, 23, 245, 1, 15, 63, 127, 255, 255, 255, 255, 23, 246, 252, 255, 255, 255, 255, 255, 255, 255, 23, 247, 0, 128, 224, 248, 252, 254, 255, 255, 23, 248, 63, 127, 255, 254, 124, 48, 0, 0
60  VDU 23, 249, 255, 255, 255, 127, 63, 15, 1, 0, 23, 250, 255, 255, 255, 255, 255, 255, 252, 252, 23, 251, 255, 254, 252, 248, 224, 128, 0, 0, 23, 252, 24, 60, 126, 126, 126, 126, 60, 24, 23, 253, 0, 0, 128, 255, 127, 63, 31, 15, 23, 254, 126, 126, 255, 255, 255, 255, 255, 255
65  VDU 23, 255, 0, 0, 1, 255, 254, 252, 248, 240
70  A$=CHR$(224)+CHR$(225):B$=CHR$(226)+CHR$(227):C$=CHR$(236)+CHR$(237):D$=CHR$(228)+CHR$(229)+CHR$(230)+CHR$(231):E$=CHR$(232)+CHR$(233)+CHR$(234)+CHR$(235):F$=CHR$(238)+CHR$(239):G$=CHR$(240)+CHR$(241):H$=CHR$(242)+CHR$(243)
75  I$=CHR$(244)+CHR$(245)+CHR$(246)+CHR$(247) : J$=CHR$(248)+CHR$(249)+CHR$(250)+CHR$(251) : K$=CHR$(252) : L$=CHR$(253)+CHR$(254)+CHR$(255)
80  CLG : LI%=3 : SC%=0
90  Z%=0 : R1%=0 : R2%=0 : R3%=0 : R4%=0 : R5%=0 : R6%=0 : A1%=1 : C1%=1 : E1%=1 : X1%=1 : U1%=1 : S1%=1 : G1%=1 : G2%=10 : B1%=1 : D1%=1 : F1%=1 : Y1%=1 : V1%=1 : T1%=1
...
1320 IF INKEY(-99)THEN GOTO 80 ELSE GOTO 1320 
1325 REM Spacebar
1330 DEFPROCIN
